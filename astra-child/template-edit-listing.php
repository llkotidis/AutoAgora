                                ...
                                <div class="form-row">
                                    <div class="vehicle-history-grid">
                                        ...
                                        $extras_options = array(
                                            ...
                                            'towing_hitch' => 'Towing Hitch',
                                            'roof_rails' => 'Roof Rails',
                                            'towbar' => 'Towbar',
                                            'spare_wheel' => 'Spare Wheel',
                                            'run_flat_tyres' => 'Run Flat Tyres',
                                            ...
                                            'electric_steering' => 'Electric Steering',
                                            'hill_hold' => 'Hill Hold',
                                            'hill_descent' => 'Hill Descent',
                                            ...
                                            'isofix' => 'ISOFIX',
                                            'child_locks' => 'Child Locks',
                                            'petrol_cap_lock' => 'Petrol Cap Lock',
                                            ...
                                            'tool_kit' => 'Tool Kit',
                                            'jack' => 'Jack',
                                            'wheel_wrench' => 'Wheel Wrench',
                                            'locking_wheel_nuts' => 'Locking Wheel Nuts',
                                            'mud_flaps' => 'Mud Flaps',
                                            'wind_deflector' => 'Wind Deflector',
                                            'boot_liner' => 'Boot Liner',
                                            'carpet_mats' => 'Carpet Mats',
                                            'rubber_mats' => 'Rubber Mats',
                                            'cargo_net' => 'Cargo Net',
                                            'cargo_cover' => 'Cargo Cover',
                                            'cargo_organizer' => 'Cargo Organizer',
                                            'cargo_rails' => 'Cargo Rails',
                                            'cargo_hooks' => 'Cargo Hooks',
                                            'cargo_floor' => 'Cargo Floor',
                                            'cargo_side_panels' => 'Cargo Side Panels',
                                            'cargo_ceiling' => 'Cargo Ceiling',
                                            'cargo_light' => 'Cargo Light',
                                            'cargo_power_outlet' => 'Cargo Power Outlet',
                                            'cargo_12v_socket' => 'Cargo 12V Socket',
                                            'cargo_230v_socket' => 'Cargo 230V Socket',
                                            'cargo_usb_port' => 'Cargo USB Port',
                                            'cargo_aux_port' => 'Cargo AUX Port',
                                            'cargo_bluetooth' => 'Cargo Bluetooth',
                                            'cargo_wifi' => 'Cargo WiFi',
                                            'cargo_gps' => 'Cargo GPS',
                                            'cargo_camera' => 'Cargo Camera',
                                            'cargo_sensor' => 'Cargo Sensor',
                                            'cargo_alarm' => 'Cargo Alarm',
                                            'cargo_lock' => 'Cargo Lock',
                                            'cargo_cover_lock' => 'Cargo Cover Lock',
                                            'cargo_floor_lock' => 'Cargo Floor Lock',
                                            'cargo_side_panel_lock' => 'Cargo Side Panel Lock',
                                            'cargo_ceiling_lock' => 'Cargo Ceiling Lock',
                                            'cargo_light_switch' => 'Cargo Light Switch',
                                            'cargo_power_outlet_switch' => 'Cargo Power Outlet Switch',
                                            'cargo_12v_socket_switch' => 'Cargo 12V Socket Switch',
                                            'cargo_230v_socket_switch' => 'Cargo 230V Socket Switch',
                                            'cargo_usb_port_switch' => 'Cargo USB Port Switch',
                                            'cargo_aux_port_switch' => 'Cargo AUX Port Switch',
                                            'cargo_bluetooth_switch' => 'Cargo Bluetooth Switch',
                                            'cargo_wifi_switch' => 'Cargo WiFi Switch',
                                            'cargo_gps_switch' => 'Cargo GPS Switch',
                                            'cargo_camera_switch' => 'Cargo Camera Switch',
                                            'cargo_sensor_switch' => 'Cargo Sensor Switch',
                                            'cargo_alarm_switch' => 'Cargo Alarm Switch',
                                            'cargo_lock_switch' => 'Cargo Lock Switch',
                                            'cargo_cover_lock_switch' => 'Cargo Cover Lock Switch',
                                            'cargo_floor_lock_switch' => 'Cargo Floor Lock Switch',
                                            'cargo_side_panel_lock_switch' => 'Cargo Side Panel Lock Switch',
                                            'cargo_ceiling_lock_switch' => 'Cargo Ceiling Lock Switch'
                                        );
